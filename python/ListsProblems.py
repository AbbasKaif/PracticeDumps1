...
"""
vari=["Bob Dylan", "Like a", "Rolling Stone"]
print vari.index("Rolling Stone")
vari.insert(0,1965)
print vari
...
varia=["McCartney", "Lennon", "Starr", "Harrison", "Sutcliffe"]
varia.remove("Sutcliffe")
print varia
m=varia.pop(1)
n=varia.pop()
print varia