...
var5=raw_input("Favrouitr Restaurant?")
var6=input("Name of a place?")
var7=input("Your nickname")
print ("Your facorite restaurant is %s, you want to visit %s, and your nickname or first name is %s"%(var5,var6,var7))